...
export class ChatBotComponent {
  ...
  public sendResponse() {
    ...
    switch (this.index) {
      case 1:
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: "¡Hola! <br>Encantado do de hablar contigo<br> ¿Puedes indicarme tu nombre?",
          type: "bot",
        });
        break;
      ...
      case 2:
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: `Encantado conocerte <b>${this.userName}</b>, <br>¿Cuál es el nombre de tu empresa?`,
          type: "bot",
        });
      ...
      case 3:
        ...
        if (emailvalid) {
          this.hora = new Date().toLocaleTimeString().slice(0, 5);
          if (!this.correo_valido)
            this.messages.push({
              text: `<b>${this.email_format.name}</b>, ¿puedes indicarme un correo para continuar?`,
              type: "bot",
            });
      ...
      case 6:
        ...
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: `<b>${this.email_format.name}</b> Indicanos que servicio estas buscando en concreto`,
          type: "bot",
        });
        break;
      ...
      case 7:
        ...
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: `¡Excelente! <b>${this.email_format.name}</b>,<br> ¿Que tipo de tipo de información estas buscando?`,
          buttons: [
            {
              text: "1. Precios",
              value: "presupuesto",
      ...
      case 9:
        ...
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: "Indicanos que tipo de consulta estas buscando en concreto",
          type: "bot",
        });
        this.index = 7;
        break;
      ...
      default:
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: `Gracias, por usar nuestro bot, si lo deseas puedes llamar o ponerte en 
  ...
  private validarCorreo(): void {
    ...
    if (emailRegex.test(this.response)) {
      ...
      this.hora = new Date().toLocaleTimeString().slice(0, 5);
      this.messages.push({
        text: `Disculpa <b>${this.email_format.name}</b>, revisa que el correo sea correcto.`,
        type: "bot",
      });
  ...
  private send_firstEmail(): void {
    ...
    this.email_format.message =
      "El usuario ha solicitado información sobre el servicio pero no ha completado el registro";

    this.svcFire
      .setCollection("contacto")
      .createDoc(this.email_format)
      .then(() => {
  ...
  private send_finalEmail(): void {
    ...
    this.email_format.date = new Date().toLocaleDateString();
    this.email_format.message =
      "El usuario ha solicitado información sobre el servicio y ha completado el registro";
    this.svcFire
      .setCollection("contacto")
      .createDoc(this.email_format)
      .then(() => {
  ...
  private revisarBoton(value: string): void {
    ...
    switch (this.response) {
      ...
      case "2":
        ...
        this.messages.push({
          ...
          buttons: [
            ...
            {
              text: "3. Marketing de Contenidos",
              value: "posicionamiento",
              type: "bot",
              number: 3,
              info: "s2",
      ...
      case "5":
        ...
        this.messages.push({
          ...
          buttons: [
            ...
            {
              text: "2. Desarrollo de Aplicaciones",
              value: "marketing",
              type: "bot",
              number: 2,
              info: "s2",
            ...
            {
              text: "4. Desarrollo de Videojuegos",
              type: "bot",
              value: "publicidad",
              number: 4,
              info: "s2",
      ...
      case "6":
        ...
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: "Indicanos que servicio estas buscando en concreto",
          type: "bot",
        });
      ...
      default:
        this.hora = new Date().toLocaleTimeString().slice(0, 5);
        this.messages.push({
          text: "Escribe un numero del 1 al 7.",
          type: "bot",
        });
        break;
    }
