...
export class IndexComponent implements OnInit {
  ...
  servicesData = [
    ...
    // },
    {
      ...
      description:
        "Los videos atraen la atención y ayudan a mejorar la comprensión y el recuerdo de tu mensaje, generando confianza y credibilidad en tu marca. Además, pueden aumentar tus tasas de conversión y ventas",
    },
    // {
    ...
    // },
    {
      ...
      description:
        "Aumenta la presencia web de tu empresa ya sea grande o pequeña, gracias a nuestros planes adaptados a tus necesidades.",
    },
    {
      icon: "uil uil-clock h1 text-primary",
      title: "Ecommerce",
      description:
        "Creamos un sitio WEB donde tus clientes podran comprar tus productos de forma totalemte automatizada.",
    },
  ];
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle(
      "Agencia de Marketing Digital en Galicia - TecnoRia"
    );
    this.metaTagService.updateTag({
      name: "description",
      content:
        "Somos una agencia de marketing digital y diseño web en Galicia. Creamos páginas web, tiendas online, posicionamiento SEO, redes sociales, branding y mucho más.",
    });
    this.metaTagService.updateTag({
      name: "keywords",
      content:
        "marketing digital, diseño web, posicionamiento seo, redes sociales, branding, tiendas online, páginas web, galicia,marketing digital en Galicia",
    });
  }
  get f() {
