...
@Component({
  ...
  standalone: true,
  imports: [ngxScrollTo, FormBottomComponent],
})
export class BlogDetailComponent {
  ...
  constructor(private svcBlog: BlogService, private meta: Meta) {
    this.meta.addTags([
  ...
  ngAfterViewInit() {
    ...
    const spanh3 = contenido.querySelectorAll(
      "h1>strong>span>span,h2>strong>span>span"
    );
    spanh3.forEach((span) => {
    ...
    const spanh4 = contenido
      .querySelectorAll("h3>strong>span>span")
      .forEach((span) => {
