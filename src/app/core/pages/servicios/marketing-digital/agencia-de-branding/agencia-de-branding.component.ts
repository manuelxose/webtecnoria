...
@Component({
  selector: "app-agencia-de-branding",
  templateUrl: "./agencia-de-branding.component.html",
  styleUrls: ["./agencia-de-branding.component.css"],
  imports: [
    ngxSclollTo,
    NgbNav,
    NgbNavOutlet,
...
export class AgenciaDeBrandingComponent {
  ...
  public redesSociales = [
    {
      ...
      title: "Facebook",
      description:
        "¿Quieres darle un empujón a tu negocio en Facebook? Nuestra agencia de redes sociales tiene un equipo de expertos especializados en esta red social, que permite hacer maravillas gracias a sus diferentes campañas. ¡A qué estás esperando para darle ese empujón a tu negocio!",
    ...
    },
    {
      ...
      title: "Instagram",
      description:
        "¿Quieres destacar en Instagram? Los influencers más grandes están aquí y gracias a nuestra agencia de redes sociales, tú también puedes aparecer en las stories y post patrocinados de tus seguidores.",
    ...
    },
    {
      ...
      title: "Linkedin",
      description:
        "¿Quieres llegar al mundo empresarial y profesional en LinkedIn? Nuestra agencia de redes sociales te ayuda a llenar tus clases, seminarios web o lo que sea que te propongas. ¡Estamos contigo!",
    ...
    },
    {
      ...
      title: "Twitter",
      description:
        "¿Quieres destacar en Twitter? Nuestra agencia de redes sociales te ayudará a crear y publicar contenido atractivo y relevante, a interactuar con tus seguidores y a lanzar campañas publicitarias para llegar a un público cada vez mayor.",
    ...
    },
    {
      ...
      title: "Youtube",
      description:
        "¿Quieres triunfar en YouTube? Es una plataforma donde tienes que estar sí o sí. Con nuestra agencia de redes sociales podrás crear y publicar contenido atractivo y optimizarlo para mejorar su posicionamiento.",
    ...
    },
    {
      ...
      title: "TikTok",
      description:
        "¿Quieres destacar en TikTok? Aunque no sea tan nuevo como hace unos años, sigue siendo una de las redes sociales más jóvenes. Con nuestra agencia de redes sociales podrás crear y publicar contenido atractivo y llegar a ese público que pasa horas haciendo scroll.",
