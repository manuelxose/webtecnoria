...
@Component({
    selector: "app-agencia-instagram-ads",
    templateUrl: "./agencia-instagram-ads.component.html",
    styleUrls: ["./agencia-instagram-ads.component.css"],
    imports: []
})
export class AgenciaInstagramAdsComponent {
  ...
  ngOnInit() {
    ...
    if (screenWidth < 768) {
      this.imagePath = "assets/images/publicidad/mobile/";
    } else if (screenWidth >= 768 && screenWidth < 992) {
      this.imagePath = "assets/images/publicidad/tablet/";
    } else if (screenWidth >= 992) {
      this.imagePath = "assets/images/publicidad/desktop/";
    }
  }
}
