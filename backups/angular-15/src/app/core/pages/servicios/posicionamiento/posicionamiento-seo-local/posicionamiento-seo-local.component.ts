...
@Component({
  selector: "app-posicionamiento-seo-local",
  templateUrl: "./posicionamiento-seo-local.component.html",
  styleUrls: ["./posicionamiento-seo-local.component.css"],
  standalone: true,
  imports: [],
})
export class PosicionamientoSeoLocalComponent {
